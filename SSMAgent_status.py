...
def lambda_handler(events,context):
    ...
    sns_topic_arn = "arn:aws:sns:eu-west-1:<accountID>:SSMAgent_PingStatus_Topic"
    status = {} 
...
def get_ping_status(regions, tags, status, accounts):
    ...
    for account in accounts:
        ...
        for region in regions:
            ...
            # get the list of currently running instances under the region
            try: 
...
def create_dashboard(status,cw):
    pass
